    ...
    public class Cripto
    {
        ...
        public static string Encriptar(string textoQueEncriptaremos)
        {
            return Encriptar(textoQueEncriptaremos,
                ConstValues.CriptInitHash, ConstValues.CriptSaltValue, ConstValues.CriptHashAlgorithm,
                ConstValues.CriptPasswordIteration, ConstValues.CriptInitVector, ConstValues.CriptKeyValue);
        }
        
        public static string Encriptar(string textoQueEncriptaremos, string passBase)
        {
            return Encriptar(textoQueEncriptaremos,
                passBase, ConstValues.CriptSaltValue, ConstValues.CriptHashAlgorithm,
                ConstValues.CriptPasswordIteration, ConstValues.CriptInitVector, ConstValues.CriptKeyValue);
        }
        ...
        {
            return Desencriptar(textoEncriptado, ConstValues.CriptInitHash, ConstValues.CriptSaltValue, ConstValues.CriptHashAlgorithm,
                ConstValues.CriptPasswordIteration, ConstValues.CriptInitVector, ConstValues.CriptKeyValue);
        }
